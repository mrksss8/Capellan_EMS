...
class DashboardController extends Controller
{
    public function index(){
        ...
        $enrolled_students_g11 = Student_Specialization_GradeLevel_SchoolYear::with('student')->where('school_year_id', '=', $active->active_SY_id)->where('sem_id','=', $active->active_sem_id)->where('gradelevel_id',1)->get();
        $enrolled_students_g12 = Student_Specialization_GradeLevel_SchoolYear::with('student')->where('school_year_id', '=', $active->active_SY_id)->where('sem_id','=', $active->active_sem_id)->where('gradelevel_id',2)->get();

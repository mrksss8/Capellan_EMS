                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                            ...
                            <div class="navi-item mb-2">
                                <a href="/metronic/demo1/custom/apps/profile/profile-1/account-information.html" class="navi-link py-4">
                                    <span class="navi-icon mr-2">
                                        <span class="svg-icon">
                            ...
                            <div class="navi-item mb-2">
                                <a href="/metronic/demo1/custom/apps/profile/profile-1/change-password.html" class="navi-link py-4">
                                    <span class="navi-icon mr-2">
                                        <span class="svg-icon">
                            ...
                            <div class="navi-item mb-2">
                                <a href="/metronic/demo1/custom/apps/profile/profile-1/email-settings.html" class="navi-link py-4">
                                    <span class="navi-icon mr-2">
                                        <span class="svg-icon">
                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-header py-3">
                        <div class="card-title align-items-start flex-column">
                            ...
                            <span class="text-muted font-weight-bold font-size-sm mt-1">Update the Student's Payment</span>
                        </div>
                        <div class="card-toolbar">
                            <button class="btn btn-success mr-2" data-toggle="modal" data-target="#exampleModal"> <i class="flaticon2-list"></i> Add Payment</button>
                    ...
                    <form class="form">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <label class="col-xl-3"></label>
                                <div class="col-lg-9 col-xl-6">
                                    <h5 class="font-weight-bold mt-10 mb-6 text-center">Payments Info</h5>
                                </div>
                            </div> 
        ...
        <form action="{{ route('payment.store') }}" method="POST">
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Input Particulars" name="payment_particulars" required/>
                </div>
                <div class="form-group">
                    <label>Amount<span class="text-danger">*</span></label>
                    <input type="number" class="form-control" placeholder="Input Amount" name="payment_amt" required/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" placeholder="Input Transaction Date" name="transaction_date" required/>
                </div>
            </div>
